...
export function RecapHeroSkeleton() {
    return (
        <div className="mb-8 animate-pulse">
            <div className="h-4 w-24 rounded bg-neutral-800" />
            <div className="mt-2 h-12 w-40 rounded bg-neutral-800" />
            <div className="mt-2 h-4 w-28 rounded bg-neutral-800" />
        </div>
    );
}

export function ActivityRadarSkeleton() {
    return (
        <div className="mb-8 animate-pulse rounded-lg border border-neutral-800 bg-neutral-900 p-4">
            <div className="mb-2 h-3 w-32 rounded bg-neutral-800" />
            <div className="mx-auto aspect-square w-full max-w-md rounded-full bg-neutral-800/60" />
        </div>
    );
}

export function RecapGridSkeleton() {
    return (
        <div className="mb-8 grid animate-pulse gap-6 sm:grid-cols-2">
            <div className="rounded-lg border border-neutral-800 bg-neutral-900 p-4">
                <div className="mb-3 h-3 w-16 rounded bg-neutral-800" />
                <div className="space-y-2">
                    {Array.from({ length: 3 }).map((_, i) => (
                        <div key={i} className="h-4 w-full rounded bg-neutral-800" />
                    ))}
                </div>
            </div>
            <div className="rounded-lg border border-neutral-800 bg-neutral-900 p-4">
                ...
                <div className="mt-1 h-3 w-24 rounded bg-neutral-800" />
            </div>
        </div>
    );
}
...
export function PersonalRecordsSkeleton() {
    return (
        <div className="animate-pulse rounded-lg border border-neutral-800 bg-neutral-900 p-4">
            <div className="mb-3 h-3 w-20 rounded bg-neutral-800" />
